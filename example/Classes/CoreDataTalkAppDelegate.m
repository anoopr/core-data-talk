...
@implementation CoreDataTalkAppDelegate
...
- (void)mergeChangesFromContextDidSaveNotification:(NSNotification *)aNote {
	if (self.managedObjectContext != [aNote object]) {
...
- (NSManagedObjectModel *)managedObjectModel {
    ...
    NSString *modelPath = [[NSBundle mainBundle] pathForResource:@"CoreDataTalk" ofType:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator {
    ...
    NSURL *storeURL = [[self applicationCachesDirectory] URLByAppendingPathComponent:@"CoreDataTalk.sqlite"];
    ...
    if (![persistentStoreCoordinator_ addPersistentStoreWithType:NSSQLiteStoreType configuration:nil URL:storeURL options:nil error:&error]) {
         ...
         */
        NSLog(@"Unresolved error %@, %@", error, [error userInfo]);
		[[NSFileManager defaultManager] removeItemAtURL:[[self applicationCachesDirectory] URLByAppendingPathComponent:@"CoreDataTalk.sqlite"] error:nil];
